...
function initAuthListeners() {
    // sb can be null if Supabase failed to load (see the guarded
    // createClient() above) — skip wiring its listener rather than
    // throwing and cutting the rest of page-load setup short.
    if (sb) {
